      ...
      <div ref={ref} className="screen-container animate-fade-in safe-top">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">Choose a recipient</p>
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          {filteredContacts.map((contact, i) => (
            <button
              ...
              className={cn(
                "w-full transaction-item animate-fade-in"
              )}
              style={{ animationDelay: `${i * 30}ms` }}
            >
              <div className={cn(
                "w-11 h-11 rounded-full flex items-center justify-center text-primary-foreground font-semibold bg-gradient-to-br",
