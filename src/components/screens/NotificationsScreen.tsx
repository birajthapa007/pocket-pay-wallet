...
const NotificationsScreen = React.forwardRef<HTMLDivElement, NotificationsScreenProps>(
        ...
        <div className="menu-section">
          {notificationItems.map((item, i) => (
            <div key={i} className="settings-item">
              <div className={`w-10 h-10 rounded-xl ${item.key === 'security' ? 'bg-success-soft' : 'bg-secondary'} flex items-center justify-center flex-shrink-0`}>
