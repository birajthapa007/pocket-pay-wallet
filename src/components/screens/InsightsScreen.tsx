  ...
  ({ transactions }, ref) => {
    ...
    return (
      <div ref={ref} className="screen-container animate-fade-in safe-top">
        ...
        {/* Protection Card */}
        <div 
          className="bg-gradient-to-br from-primary-soft to-primary/5 rounded-2xl p-4 sm:p-5 border border-primary/20 mb-6 animate-fade-in"
        ...
        >
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-foreground mb-1 text-sm sm:text-base">Smart Protection</p>
              <p className="text-xl sm:text-2xl font-bold text-primary">{formatCurrency(fraudBlocked)}</p>
        ...
        >
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-info-soft flex items-center justify-center flex-shrink-0">
              <Activity className="w-5 h-5 sm:w-6 sm:h-6 text-info" />
            </div>
            <div className="flex-1">
              <p className="text-sm text-muted-foreground">Total transactions</p>
              <p className="text-xl sm:text-2xl font-bold text-foreground">{monthlyTransactions.length}</p>
